                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="flex items-center justify-end mt-4 mb-4">
                                        <a class="btn" href="{{ url('login/github') }}"
                                           style="background: gray; color: #ffffff; padding: 10px; width: 100%; text-align: center; display: block; border-radius:3px;">
                                            Login with Github
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    {{-- Login with Google --}}
                                    <div class="flex items-center justify-end mt-4 mb-4">
                                        <a class="btn btn-danger btn-block" href="{{ url('login/google') }}"
                                           style="padding: 10px; width: 100%; text-align: center; display: block; border-radius:3px;">
                                            Login with Google
                                        </a>
                                    </div>
